 ...
 * ClassA를 상속받아서 마치 ClassA의 method들이 정의되어 있는것 처럼
 * 사용이 가능하다
 * 
 *  객체지향(OOP) 프로그래밍에서 클래스를 상속받기
 *  기존에 잘 만들어진 클래스 코드가 있으면, 
 *  그 클래스 코드를 내가 만든 클래스에서 사용하고 싶을때
 *  ClassA는 매우 잘 만들어진 클래스라고 할때
 *  ClassB는 ClassA의 method들을 그대로 물려받아서 사용할수 있다.
 *  만약 원래 ClassA 개발자가 코드를 Upgrade하면 
 *  ClassB도 같이 Upgrade되는 효과를 낼수 있다. 
 */
public class ClassB extends ClassA{
	...
	/*
	 * Object를 상속받는 모든 클래스는 기본적으로 toStirng() method가 있다.
	 * 기본 toString() method 클래스의 패키지명, 메모리 주소등을 문자열로 return 한다.
	 * 
