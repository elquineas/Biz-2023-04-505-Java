 ...
 *      각 속성에 접근을 하기위해 getter, setter method를 선언하는 패턴을 사용한다.
 */
...
public class BookDto {
	 ...
	 *    getter, setter, toString, 생성자 2개를 모두 지우고
	 *  변수명 또는 변수의 type을 변경하고
	 *    getter, setter, toString, 생성자 2개를 다시 생성한다
	 *  
	 *  변수명을 수정하고, getter, setter등을 수정해 주어야 하는데
	 *  그러는 과정에서 수정을 빼먹는 상황이 발생할수 있다.
	 *  
	 *  코드를 reFactoring 할대 가장 많은 문제를 발생시킬수 있다.
	 */
	...
	public BookDto(String bIsbn,String bTitle,String bPublisher,
			       String bAuthor,String bPublishDate,
			       int bPages,int bPrice) {
		super();
		this.bIsbn = bIsbn;
		this.bTitle = bTitle;
